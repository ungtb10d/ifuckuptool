/* eslint-env node */
const { reducePromiseFunctions, blcktive } = require('./util').blcktive;
...
function parse(string, opts) {
  ...
  if (opts.templateProcessors)
    return reducePromiseFunctions(opts.templateProcessors, tpl).then(tpl => {
      stringify(tpl, opts);
    });
