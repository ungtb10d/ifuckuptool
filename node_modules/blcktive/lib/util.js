...
const devFile = path.resolve(basePath, '../.build/blcktive.js');
const modFile = path.resolve(basePath, '../blcktive.js');
const blcktive = require(stat(modFile) ? modFile : devFile);
